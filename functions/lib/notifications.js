...
exports.onActivityCreated = functionsV1
    ...
    if (activity.type === "learning_completion") {
        ...
        // Push
        await (0, notificationUtils_1.sendPush)(uid, "Module Completed!", `You finished ${activity.resourceName}. Great job!`, {
...
exports.onBackgroundTaskUpdated = functionsV1
    .runWith({ secrets: [smtpEmail, smtpPassword] })
    .firestore
    ...
    if (before.status !== "completed" && after.status === "completed") {
        ...
        if (title) {
            ...
            await (0, notificationUtils_1.sendPush)(uid, title, body, data);
        }
 ...
 */
exports.sendAccountStatusEmail = functionsV1
    .runWith({ secrets: [smtpEmail, smtpPassword] })
 ...
 */
exports.checkUserProvider = functionsV1
    .region("us-central1")
 ...
 */
exports.restoreUserAuth = functionsV1
    .region("us-central1")
    .https.onCall(async (data, context) => {
    // 1. Security Check
 ...
 */
exports.deleteUserAuth = functionsV1
    .region("us-central1")
    .https.onCall(async (data, context) => {
    // 1. Security Check
