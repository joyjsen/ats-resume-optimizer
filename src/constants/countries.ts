...
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
    ...
    { name: "Congo, The Democratic Republic of the", code: "+243", iso: "CD" },
    ...
    { name: "Falkland Islands (Malvinas)", code: "+500", iso: "FK" },
    ...
    { name: "Holy See (Vatican City State)", code: "+379", iso: "VA" },
    ...
    { name: "Iran, Islamic Republic Of", code: "+98", iso: "IR" },
    ...
    { name: "Korea, Democratic People's Republic of", code: "+850", iso: "KP" },
    { name: "Korea, Republic of", code: "+82", iso: "KR" },
    { name: "Kuwait", code: "+965", iso: "KW" },
    { name: "Kyrgyzstan", code: "+996", iso: "KG" },
    { name: "Lao People's Democratic Republic", code: "+856", iso: "LA" },
    { name: "Latvia", code: "+371", iso: "LV" },
    { name: "Lebanon", code: "+961", iso: "LB" },
    { name: "Lesotho", code: "+266", iso: "LS" },
    { name: "Liberia", code: "+231", iso: "LR" },
    { name: "Libyan Arab Jamahiriya", code: "+218", iso: "LY" },
    ...
    { name: "Macedonia, The Former Yugoslav Republic of", code: "+389", iso: "MK" },
    ...
    { name: "Micronesia, Federated States of", code: "+691", iso: "FM" },
    { name: "Moldova, Republic of", code: "+373", iso: "MD" },
    ...
    { name: "Palestinian Territory, Occupied", code: "+970", iso: "PS" },
    ...
    { name: "Russian Federation", code: "+7", iso: "RU" },
    ...
    { name: "South Georgia and the South Sandwich Islands", code: "+500", iso: "GS" },
    ...
    { name: "Syrian Arab Republic", code: "+963", iso: "SY" },
    { name: "Taiwan, Province of China", code: "+886", iso: "TW" },
    { name: "Tajikistan", code: "+992", iso: "TJ" },
    { name: "Tanzania, United Republic of", code: "+255", iso: "TZ" },
    ...
    { name: "Viet Nam", code: "+84", iso: "VN" },
    { name: "Virgin Islands, British", code: "+1-284", iso: "VG" },
    { name: "Virgin Islands, U.S.", code: "+1-340", iso: "VI" },
