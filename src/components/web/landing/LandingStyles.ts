...
export const ls = StyleSheet.create({
    ...
    sectionTitle: { fontSize: 36, fontWeight: '800', color: C.textPrimary, textAlign: 'center', marginBottom: 12, letterSpacing: -0.5 },
    ...
    headerLogoText: { fontSize: 22, fontWeight: '800', color: C.white, letterSpacing: -0.5 },
    ...
    heroTagline: { fontSize: 52, fontWeight: '900', color: C.white, lineHeight: 62, letterSpacing: -1, marginBottom: 20 },
    ...
    featureCardTitle: { fontSize: 19, fontWeight: '700', color: C.textPrimary, marginBottom: 8 },
    ...
    stepTitle: { fontSize: 19, fontWeight: '700', color: C.textPrimary, marginBottom: 8, textAlign: 'center' },
    ...
    detailedFeatureTitle: { fontSize: 42, fontWeight: '800', color: C.textPrimary, marginBottom: 16, letterSpacing: -1 },
    ...
    valuePropTitle: { fontSize: 18, fontWeight: '700', color: C.textPrimary, marginBottom: 8 },
    ...
    blogPreviewTitle: { fontSize: 20, fontWeight: '700', color: C.textPrimary, marginVertical: 12, lineHeight: 28 },
    ...
    testiName: { fontSize: 16, fontWeight: '700', color: C.textPrimary },
    ...
    footerBrandName: { fontSize: 22, fontWeight: '800', color: C.white, marginBottom: 12 },
